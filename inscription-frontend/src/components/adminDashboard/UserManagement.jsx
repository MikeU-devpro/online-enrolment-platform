...
const UserManagement = () => {
    ...
    const users = [
        { id: 'USR001', firstName: 'Jean', lastName: 'Dupont', email: 'jean.dupont@example.com', role: 'Administrateur', status: 'Actif' },
        { id: 'USR002', firstName: 'Marie', lastName: 'Curie', email: 'marie.curie@example.com', role: 'Étudiant', status: 'Inactif' },
        { id: 'USR003', firstName: 'Ahmed', lastName: 'Benali', email: 'ahmed.benali@example.com', role: 'Étudiant', status: 'Actif' },
        { id: 'USR004', firstName: 'Sophie', lastName: 'Martin', email: 'sophie.martin@example.com', role: 'Administrateur', status: 'Actif' },
        { id: 'USR005', firstName: 'Fatima', lastName: 'Zahra', email: 'fatima.zahra@example.com', role: 'Étudiant', status: 'Actif' },
    ];
