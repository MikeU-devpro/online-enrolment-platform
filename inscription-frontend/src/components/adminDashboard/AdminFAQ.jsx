...
const AdminFAQ = () => {
    const faqItems = [
        ...
        {
            question: "Comment ajouter une nouvelle filière ?",
            answer: "Dans la section 'Gestion des Filières', cliquez sur 'Ajouter une filière'. Remplissez les informations requises telles que le nom, la description et les conditions d'admission."
        },
        {
