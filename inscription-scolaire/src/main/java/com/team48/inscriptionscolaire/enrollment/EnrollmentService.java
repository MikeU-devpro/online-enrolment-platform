...
public class EnrollmentService {
    ...
    private final NotificationService notificationService; // Added notification service
    ...
    public EnrollmentDtoResponse approveEnrollment(Integer enrollmentId) {
        ...
        String subject = "Demande d'inscription approuvée";
        String message = "Félicitations ! Votre demande d'inscription pour le programme " + enrollment.getProgram().getProgramName() + " a été approuvée. Vous pouvez maintenant procéder au paiement.";
        notificationService.createNotification(enrollment.getStudent(), subject, message, enrollment.getId());
    ...
    public EnrollmentDtoResponse requestCorrections(Integer enrollmentId, List<DocumentCorrectionDto> corrections) {
        ...
        String subject = "Corrections requises pour votre inscription";
    ...
    public EnrollmentDtoResponse rejectEnrollment(Integer enrollmentId, String rejectionReason) {
        ...
        String subject = "Demande d'inscription rejetée";
